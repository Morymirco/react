      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
            <Link className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" to="/">Home</Link>
            {/* <a href="#" className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">Tableau de bord</a> */}
            <Link className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" to="/todo">TodoS</Link>
            ...
            <Link className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" to="/photo" aria-current="page">Photo</Link>
            <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">calendrier</a>
          </div>
        </div>
      </div>
