...
import Head from '../Photocomponent/Head';
import Load from '../Photocomponent/load';
const Home = () => {
    return (
        <div >
<header className="bg-blue- dark:bg-gray-800">
<Head></Head>
    <div class="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
        <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
            ...
            <div class="max-w-lg md:mx-12 md:order-2">
                <h1 class="text-3xl font-medium tracking-wide text-gray-900 dark:text-white md:text-4xl">The best Apple Watch apps</h1>
